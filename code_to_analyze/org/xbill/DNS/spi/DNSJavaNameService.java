...
public class DNSJavaNameService implements NameService {
  ...
  protected DNSJavaNameService() {
    ...
    try {
      ...
      Class<S> inetAddressImplFactoryClass = Class.forName("java.net.InetAddressImplFactory");
      ...
      Class<D> inetAddressImplClass = Class.forName("java.net.InetAddressImpl");
  ...
  public InetAddress[] lookupAllHostAddr(String host) throws UnknownHostException {
    ...
    if (records == null) {
      records = new Lookup(name, Type.A);
    }
  ...
  public String getHostByAddr(byte[] addr) throws UnknownHostException {
    ...
    Record[] records = new Lookup(name, Type.PTR);
    if (records == null) {
      throw new UnknownHostException("Unknown address: " + name);
    }
    return records.getTarget().toString();
  }
}
